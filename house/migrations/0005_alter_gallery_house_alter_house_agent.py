...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('house', '0004_rename_agents_house_agent_and_more'),
    ...
    operations = [
        migrations.AlterField(
            model_name='gallery',
            name='house',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gallery', to='house.house', verbose_name='house'),
        ),
        migrations.AlterField(
            model_name='house',
            name='agent',
